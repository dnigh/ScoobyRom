...
*	**Linux/Mac/Windows**: Mono
	...
	Windows alternative to Microsofts Framework: Mono + GTK# install, see next chapter.
...
A few (text labelling) commands are generated within the app on the fly, you need to change app source code for this.
