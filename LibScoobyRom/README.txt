...
Main library for _ScoobyRom_, provides ROM file logic. Independent from
...
Nothing to do as it is part of the ScoobyRom "solution", compiled and
copied automatically. See ScoobyRom GUI application project.
